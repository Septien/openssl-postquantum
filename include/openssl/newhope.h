...
typedef struct newhope_pair_st NEWHOPE_PAIR;
...
size_t NEWHOPE_compute_key_alice(unsigned char *out, size_t outlen, const unsigned char *ct, const NEWHOPE_PUB *alice_keypub, void *(*KDF)(const void *in, size_t inlen, void *out, size_t *outlen));
size_t NEWHOPE_compute_key_bob(unsigned char *out, size_t outlen, const NEWHOPE_PAIR *pub_bob, unsigned char *ct, void *(*KDF)(const void *in, size_t inlen, void *out, size_t *outlen));
