...
main()
{
    ...
    unsigned char       m[33] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF, 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF, 0xFF}, m2[33] = {0};
    ...
    int i;
    printf("Maximum length of message:\n%d bytes", NEWHOPE_SYMBYTES);
    printf("\n\nMessage:\n");
    for (i = 0; i < 33; i++)
        printf("%x ", m[i]);
